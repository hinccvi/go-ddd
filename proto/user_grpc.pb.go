...
type UserServiceClient interface {
	...
	QueryUser(ctx context.Context, in *QueryUserRequest, opts ...grpc.CallOption) (*QueryUserReply, error)
...
func (c *userServiceClient) QueryUser(ctx context.Context, in *QueryUserRequest, opts ...grpc.CallOption) (*QueryUserReply, error) {
	out := new(QueryUserReply)
	err := c.cc.Invoke(ctx, "/v1.user.UserService/QueryUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	QueryUser(context.Context, *QueryUserRequest) (*QueryUserReply, error)
...
func (UnimplementedUserServiceServer) QueryUser(context.Context, *QueryUserRequest) (*QueryUserReply, error) {
...
func _UserService_QueryUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/v1.user.UserService/QueryUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
